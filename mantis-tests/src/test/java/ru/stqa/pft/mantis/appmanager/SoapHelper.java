...
public class SoapHelper {
    ...
    public Set<Project> getProjects() throws ServiceException, MalformedURLException, RemoteException {
        ...
        ProjectData[] projects = mc.mc_projects_get_user_accessible(adminLogin, password);
    ...
    public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        String[] categories = mc.mc_project_get_categories(adminLogin, password,
        ...
        BigInteger issueId = mc.mc_issue_add(adminLogin, password, issueData);
        IssueData createdIssueData = mc.mc_issue_get(adminLogin, password, issueId);
        return new Issue()
    ...
    public IssueData getIssue(int issueId) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        return mc.mc_issue_get(adminLogin, password,BigInteger.valueOf(issueId));
    }
}
